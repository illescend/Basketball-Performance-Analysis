...
def fit_shot_trajectory_parameters(observed_wcs_trajectory_data, fps, initial_P0_guess, initial_V_speed_angle_guess,
    ...
    print(f"DEBUG: initial_P0_guess type: {type(initial_P0_guess)}")
    print(f"DEBUG: initial_P0_guess value: {initial_P0_guess}")
    print(
        f"DEBUG: initial_P0_guess shape (if numpy array): {initial_P0_guess.shape if isinstance(initial_P0_guess, np.ndarray) else 'Not a numpy array'}")

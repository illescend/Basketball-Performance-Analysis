...
SHOOTING_WRIST_KP_INDEX = 10

# Release Detection Parameters
CONFIRMATION_FRAMES_FOR_RELEASE = 2  # Wrist must be outside ball for this many consecutive frames
...
# Pose Keypoint Indices (COCO format, used by YOLOv8-Pose) ---
...
def fit_trajectory_ccs(trajectory_points_ccs_list, initial_fps):
    ...
    try:
        ...
        initial_position_ccs = np.array(popt[3:6])
    except RuntimeError:
